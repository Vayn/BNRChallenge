...
- (IBAction)showAssetTypePicker:(id)sender {
    ...
    if ([UIDevice currentDevice].userInterfaceIdiom == UIUserInterfaceIdiomPad) {
        ...
        UINavigationController *assetNC = [[UINavigationController alloc] initWithRootViewController:avc];

        self.assetTypePopover = [[UIPopoverController alloc] initWithContentViewController:assetNC];
        self.assetTypePopover.delegate = self;

        [self.assetTypePopover presentPopoverFromBarButtonItem:sender
                                      permittedArrowDirections:UIPopoverArrowDirectionAny
                                                      animated:YES];
    } else {
