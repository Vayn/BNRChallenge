...
- (BNRItem *)createItem
{
    ...
    NSLog(@"Adding after %d items, order = %.2f", (int)[self.privateItems count], order);
    ...
    item.serialNumber = randomSerialNumber;
...
- (void)addAssetType:(NSManagedObject *)newType
{
    [_allAssetTypes addObject:newType];
}
